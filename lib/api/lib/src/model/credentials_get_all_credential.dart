...
part 'credentials_get_all_credential.g.dart';
...
@BuiltValue()
abstract class CredentialsGetAllCredential
    implements
        Built<CredentialsGetAllCredential, CredentialsGetAllCredentialBuilder> {
  ...
  CredentialsGetAllCredential._();

  factory CredentialsGetAllCredential(
          [void updates(CredentialsGetAllCredentialBuilder b)]) =
      _$CredentialsGetAllCredential;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(CredentialsGetAllCredentialBuilder b) => b;

  @BuiltValueSerializer(custom: true)
  static Serializer<CredentialsGetAllCredential> get serializer =>
      _$CredentialsGetAllCredentialSerializer();
}

class _$CredentialsGetAllCredentialSerializer
    implements PrimitiveSerializer<CredentialsGetAllCredential> {
  @override
  ...
  @override
  final String wireName = r'CredentialsGetAllCredential';

  Iterable<Object?> _serializeProperties(
    Serializers serializers,
    CredentialsGetAllCredential object, {
  ...
  void _deserializeProperties(
    ...
    required CredentialsGetAllCredentialBuilder result,
  ...
  @override
  CredentialsGetAllCredential deserialize(
    Serializers serializers,
    Object serialized, {
    FullType specifiedType = FullType.unspecified,
  }) {
    final result = CredentialsGetAllCredentialBuilder();
