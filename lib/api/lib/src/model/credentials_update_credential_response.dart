...
part 'credentials_update_credential_response.g.dart';
...
@BuiltValue()
abstract class CredentialsUpdateCredentialResponse
    implements
        Built<CredentialsUpdateCredentialResponse,
            CredentialsUpdateCredentialResponseBuilder> {
  ...
  CredentialsUpdateCredentialResponse._();

  factory CredentialsUpdateCredentialResponse(
          [void updates(CredentialsUpdateCredentialResponseBuilder b)]) =
      _$CredentialsUpdateCredentialResponse;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(CredentialsUpdateCredentialResponseBuilder b) => b;

  @BuiltValueSerializer(custom: true)
  static Serializer<CredentialsUpdateCredentialResponse> get serializer =>
      _$CredentialsUpdateCredentialResponseSerializer();
}

class _$CredentialsUpdateCredentialResponseSerializer
    implements PrimitiveSerializer<CredentialsUpdateCredentialResponse> {
  @override
  ...
  @override
  final String wireName = r'CredentialsUpdateCredentialResponse';

  Iterable<Object?> _serializeProperties(
    Serializers serializers,
    CredentialsUpdateCredentialResponse object, {
  ...
  void _deserializeProperties(
    ...
    required CredentialsUpdateCredentialResponseBuilder result,
  ...
  @override
  CredentialsUpdateCredentialResponse deserialize(
    Serializers serializers,
    Object serialized, {
    FullType specifiedType = FullType.unspecified,
  }) {
    final result = CredentialsUpdateCredentialResponseBuilder();
